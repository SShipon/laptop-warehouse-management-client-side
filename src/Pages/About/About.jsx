    ...
    return (
        <Container>
            <Row className='d-flex align-items-center my-5'>
                ...
                <Col md={6} sx={12}>
                   <img style={{width:'450px',height:'350px'}} src="https://images.pexels.com/photos/1006293/pexels-photo-1006293.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                </Col>
            </Row>
        </Container>
    );
